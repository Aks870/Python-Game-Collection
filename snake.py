...
while True: #the game loop covers actual movement handling, the game over conditions, the figure and score function
    ...
    if snake_pos[0] == foodpos[0] and snake_pos[1] == foodpos[1]: # snake meets the food score is increases and it is 
        score +=10
        food = False
